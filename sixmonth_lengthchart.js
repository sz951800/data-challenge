...
d3.json("sixmonth.json").then(function (data) {
    ...
    const svg = d3.select("#line-chart-container-six")
        .append("svg")
        .attr("width", width)
        .attr("height", height);
    ...
    svg.append("text")
        ...
        .attr("y", margin.top / 2)
        .style("text-anchor", "middle")
        .text("Trailing 6-month rent growth Over Time");
    ...
    const dots = svg.selectAll(".dot")
        ...
        .on("mouseout", function() {
            d3.select("#tooltip-six").style("visibility", "hidden");
        });
});
